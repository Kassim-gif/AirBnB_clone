...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for testing prompting of tha HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for testing help messages of tha HBNB command interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for testing exiting from tha HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for testing create from tha HBNB command interpreter."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for testing destroy from tha HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for tha testing update from tha HBNB command interpreter."""
